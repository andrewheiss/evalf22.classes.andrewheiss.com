...
- [{{< fa brands r-project >}} Live R script](https://www.dropbox.com/s/2fpzcybu3nvmwzl/live.R)
- [{{< fa file-csv >}} `atl-weather-2019.csv`](https://datavizs21.classes.andrewheiss.com/data/atl-weather-2019.csv)
