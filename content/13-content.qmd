...
- {{< fa arrow-up-right-from-square >}} ["Generating random numbers"](/example/random-numbers/)
- {{< fa arrow-up-right-from-square >}} ["The ultimate guide to generating synthetic data for causal inference"](/example/synthetic-data/)
