...
- [<i class="fas fa-table"></i> `father_education.csv`](/files/data/generated_data/father_education.csv)
- [<i class="fas fa-table"></i> `wage2.csv`](/files/data/package_data/wage2.csv)
- [<i class="fas fa-table"></i> `card.csv`](/files/data/package_data/card.csv)
