...
# TODO: You *don't* need to extract all the cell A, cell B, cell C, and cell D
# numbers. Just make a table of averages
```
...
$$
\text{Donation rate}\ =\ \beta_0 + \beta_1\ \text{Treatment} + \beta_2\ \text{State} + \beta_3\ \text{Quarter}
$$
