...
dice_1 <- '<img src="/img/dice/1.svg" class="dice" alt="1">'
dice_2 <- '<img src="/img/dice/2.svg" class="dice" alt="2">'
dice_3 <- '<img src="/img/dice/3.svg" class="dice" alt="3">'
dice_4 <- '<img src="/img/dice/4.svg" class="dice" alt="4">'
dice_5 <- '<img src="/img/dice/5.svg" class="dice" alt="5">'
dice_6 <- '<img src="/img/dice/6.svg" class="dice" alt="6">'
