...
.box-2.medium[Sensitivity analysis]
...
.box-3.large[I keep reading about estimates, estimands, and estimators.<br>What are these and are they the same thing?]
...
.center[
<figure>
  <img src="img/09-class/estimands-methods.png" alt="Estimand methods" title="Estimand methods" width="75%">
</figure>
]
