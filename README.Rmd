...
1. Install version 2022.07.1 later of [RStudio](https://www.rstudio.com/products/rstudio/download/#download), since it has a [Quarto](https://quarto.org/) installation embedded in it. Otherwise, download and install [Quarto](https://quarto.org/) separately.
