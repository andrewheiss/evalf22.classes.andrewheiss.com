...
1. If you're using R on your own computer, download this file, [*unzip it*](/resource/unzipping.qmd), and double click on the file named `problem-set-4.Rproj`: [<i class="fas fa-file-archive"></i> `problem-set-4.zip`](/projects/problem-set-4.zip)
    ...
    (Alternatively, you can open the project named "Problem Set 4" on RStudio.cloud and complete the assignment in your browser without needing to install anything. If you don't have access to the class RStudio.cloud account, *please let me know as soon as possible*. [This link should take you to the project](https://rstudio.cloud/spaces/205054/project/3424170)—if it doesn't, log in and look for the project named "Problem Set 4.")
