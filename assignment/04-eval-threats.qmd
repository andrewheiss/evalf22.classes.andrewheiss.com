...
**I've created an R Markdown template you can use here:** [{{< fa file-archive >}} `threats-validity.zip`](/projects/threats-validity.zip). It's also [available on RStudio.cloud](https://rstudio.cloud/spaces/205054/project/3424200).
