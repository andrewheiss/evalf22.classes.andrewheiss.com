...
- **Diff-in-diff**: [Example](/example/diff-in-diff.qmd) + Problem Sets 4 and 5
...
- [{{< fa file-archive >}} `problem-set-8.zip`](/projects/problem-set-8.zip)
...
1. If you're using R on your own computer, download this file, [*unzip it*](/resource/unzipping.qmd), and double click on the file named `problem-set-8.Rproj`: [{{< fa file-archive >}} `problem-set-8.zip`](/projects/problem-set-8.zip)
    ...
    (Alternatively, you can open the project named "Problem Set 8" on RStudio.cloud and complete the assignment in your browser without needing to install anything. [This link should take you to the project](https://rstudio.cloud/spaces/205054/project/3424176)—if it doesn't, log in and look for the project named "Problem Set 8.")
...
3. Complete the tasks given in the R Markdown file. You can remove any of the question text if you want.
    ...
    You can definitely copy, paste, and adapt from other code in the document or [the different example pages](/example/index.qmd)—don't try to write everything from scratch!.
...
4. When you're all done, click on the "Knit" button at the top of the editing window and create an HTML or Word version (or PDF if you've [installed **tinytex**](/resource/install.qmd#install-tinytex)) of your document. Upload that file to iCollege.
